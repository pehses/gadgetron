...
unsigned short get_index(const ISMRMRD::AcquisitionHeader& header, TriggerDimension index) {
    ...
    case TriggerDimension::kspace_encode_step_1:
        return header.idx.kspace_encode_step_1;
    case TriggerDimension::kspace_encode_step_2:
        return header.idx.kspace_encode_step_2;
    case TriggerDimension::average:
        return header.idx.average;
    case TriggerDimension::slice:
        return header.idx.slice;
    case TriggerDimension::contrast:
        return header.idx.contrast;
    case TriggerDimension::phase:
        return header.idx.phase;
    case TriggerDimension::repetition:
        return header.idx.repetition;
    case TriggerDimension::set:
        return header.idx.set;
    case TriggerDimension::segment:
        return header.idx.segment;
    case TriggerDimension::user_0:
        return header.idx.user[0];
    case TriggerDimension::user_1:
        return header.idx.user[1];
    case TriggerDimension::user_2:
        return header.idx.user[2];
    case TriggerDimension::user_3:
        return header.idx.user[3];
    case TriggerDimension::user_4:
        return header.idx.user[4];
    case TriggerDimension::user_5:
        return header.idx.user[5];
    case TriggerDimension::user_6:
        return header.idx.user[6];
    case TriggerDimension::user_7:
        return header.idx.user[7];
    case TriggerDimension::parallel_calibration:
        return (unsigned short)header.isFlagSet(ISMRMRD::ISMRMRD_ACQ_IS_PARALLEL_CALIBRATION);
    case TriggerDimension::n_acquisitions:
        return 0;
    case TriggerDimension::none:
        return 0;
    }
...
struct EqualityTrigger {
    ...
    static bool trigger_after(const ISMRMRD::AcquisitionHeader& head) { return false; }
};
...
struct NumAcquisitionsTrigger {
    explicit NumAcquisitionsTrigger(size_t target_acquisitions_first, size_t target_acquisitions)
        : target_acquisitions_first{target_acquisitions_first}, target_acquisitions{target_acquisitions} {}
    const size_t target_acquisitions_first;
    const size_t target_acquisitions;
    size_t num_acquisitions = 0;
    bool first = true;

    static bool trigger_before(const ISMRMRD::AcquisitionHeader& head) { return false; }
...
Trigger get_trigger(const AcquisitionAccumulateTriggerGadget& gadget) {
    ...
    case TriggerDimension::user_6:
    case TriggerDimension::user_7:
        return EqualityTrigger(gadget.trigger_dimension);
    case TriggerDimension::parallel_calibration:
        return FlagRemovedTrigger(gadget.trigger_dimension);
    case TriggerDimension::n_acquisitions:
        return NumAcquisitionsTrigger(gadget.n_acquisitions_before_trigger,
                                      gadget.n_acquisitions_before_ongoing_trigger);
    case TriggerDimension::none:
        return NoneTrigger();
    default:
        throw std::runtime_error("ENUM TriggerDimension is in an invalid state.");
    }
}
...
void AcquisitionAccumulateTriggerGadget::send_data(Core::OutputChannel& out,
                                                   std::map<unsigned short, AcquisitionBucket>& buckets,
...
const std::map<std::string, TriggerDimension> triggerdimension_from_name = {
    ...
    {"average", TriggerDimension::average},
    {"slice", TriggerDimension::slice},
    {"contrast", TriggerDimension::contrast},
    {"phase", TriggerDimension::phase},
    {"repetition", TriggerDimension::repetition},
    {"set", TriggerDimension::set},
    {"segment", TriggerDimension::segment},
    {"user_0", TriggerDimension::user_0},
    {"user_1", TriggerDimension::user_1},
    {"user_2", TriggerDimension::user_2},
    {"user_3", TriggerDimension::user_3},
    {"user_4", TriggerDimension::user_4},
    {"user_5", TriggerDimension::user_5},
    {"user_6", TriggerDimension::user_6},
    {"user_7", TriggerDimension::user_7},
    {"parallel_calibration", TriggerDimension::parallel_calibration},
    {"n_acquisitions", TriggerDimension::n_acquisitions},
    {"none", TriggerDimension::none},
